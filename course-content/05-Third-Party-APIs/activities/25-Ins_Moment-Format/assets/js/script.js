...
var today = moment();
console.log("today", today);//_isAMomentObject: true
...
// YYYY Year 2022
//YY 22
$("#1a").text(today.format("MMM Do, YYYY"));//2022
...
$("#2a").text(dayWeek);//Today is Monday
...
$("#3a").text(reformatDate);//Tuesday, November 3rd 2020, 12:00:00 am
